...
router.post('/', async (req, res) => {
  try {
    ...
    if (rows[0]) {
      ...
      sendReworkOutReport(rows[0], absolutePaths, absInvoicePaths).catch((e) => console.error('[Email] Rework Out send error:', e));
    }
...
router.post('/:id/email-report', async (req, res) => {
  try {
    ...
    await sendReworkOutReport(rows[0], imgPaths, invoiceImgPaths);
